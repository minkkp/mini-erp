...
동일 자원에 집중 요청이 발생하는 환경에서  
낙관적 락은 높은 처리량을 제공하지만 실패율이 증가하며,  
비관적 락은 정합성을 보장하는 대신 응답 시간이 크게 증가함을 확인했습니다.

생산 트랜잭션 특성상 대기 시간이 길어질 경우 시스템 병목이 발생할 수 있다고 판단하여  
최종적으로 낙관적 락 전략을 선택했습니다.
<br><br>
