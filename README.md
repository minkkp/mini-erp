...
본 프로젝트는  
생산 및 재고 관리 도메인에서 발생하는 정합성 문제를 설계로 해결하는 것에  
초점을 둔 백엔드 중심 토이 프로젝트입니다.

대규모 트래픽 처리보다는,  
재고·생산 흐름에서의 트랜잭션 경계, 실패 전략, 데이터 무결성을  
명확하게 정의하는 데 집중했습니다.
...
### 생산 실적 등록
<img width="1341" height="731" alt="image" src="https://github.com/user-attachments/assets/d77c002f-7126-407c-98d2-4f0003d4554e" />

### 자재 입고 및 재고 조회
<img width="1107" height="603" alt="image" src="https://github.com/user-attachments/assets/da64ed6f-64ef-483b-bbfd-7427546bdcba" />
<img width="1254" height="374" alt="image" src="https://github.com/user-attachments/assets/8a9f460e-2dda-49d4-a9b0-0e56f47bc22f" />


---

## ERD
<img width="817" height="730" alt="image" src="https://github.com/user-attachments/assets/abfb666d-646a-4eab-98bb-2dd1b7ebe328" />
- 재고는 현재 상태(Stock)와 변경 이력(StockHistory)을 분리하여 관리
...
단순 CRUD를 넘어 도메인 규칙을 중심으로 한 백엔드 설계를 목표로 한 프로젝트입니다.
